...
public class BuncoStrategie implements Strategy {
    ...
    public int calculerScoreTour(Jeu jeu) {
        /***
         * Dans le cas où un joueur obtient trois chiffres identiques et égaux au numéro
         * du tour, le score calculé est 21 points et si le joueur passe la main au
         * joueur suivant. Dans le cas d'obtention de 3 chiffres identiques mais
         * différents du numéro de tour si le score est de 5 points et le joueur garde
         * la main. Dans le cas d'obtention d'un seul chiffre correspondant au numéro de
         * tour si le score est correct et si le joueur garde la main. Dans le cas
         * d'obtention de 0 point si le joueur passe la main au joueur suivant. Le
         * classement final des joueurs avec différents scores.
         */
        ...
        for (int numeroTourJeu = 1; numeroTourJeu <= 6; numeroTourJeu++) {
            do {
                rollDices();
                System.out.println("\n Tour : " + numeroTourJeu);
                System.out.println("\tDé Un : " + dePremier.getNumeroDe() + " \tDé Deux : " + deDeuxieme.getNumeroDe()
                        + " \tDé Trois : " + deTroisieme.getNumeroDe());

                if (dePremier.getNumeroDe() == deDeuxieme.getNumeroDe()
                        && dePremier.getNumeroDe() == deTroisieme.getNumeroDe()) {
                ...
                } else if (dePremier.getNumeroDe() != numeroTourJeu && deDeuxieme.getNumeroDe() != numeroTourJeu
                        && deTroisieme.getNumeroDe() != numeroTourJeu) {
